...
from Frog_predator_neuro_fast.config import CYAN, FOOD_RADIUS, MAX_LOG_LINES, TILE_SIZE
from Frog_predator_neuro_fast.utils import tile_center
...
class WorldLogger:
    def __init__(self, path):
        ...
        self.log_plain("=== Frog_predator_neuro_fast Biological Simulation ===")
