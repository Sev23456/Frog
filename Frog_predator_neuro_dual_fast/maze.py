...
from Frog_predator_neuro_dual_fast.config import BLUE, CARDINALS, GREEN, MAZE_WIDTH, PASSABLE_CHARS, SPAWNABLE_CHARS
from Frog_predator_neuro_dual_fast.models import Room
