...
from Frog_predator_neuro_dual_fast.config import CYAN, FOOD_RADIUS, MAX_LOG_LINES, TILE_SIZE
from Frog_predator_neuro_dual_fast.utils import tile_center
...
class WorldLogger:
    def __init__(self, path):
        ...
        self.log_plain("=== Frog_predator_neuro_dual_fast Biological Simulation ===")
