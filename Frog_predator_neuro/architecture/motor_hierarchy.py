...
class MotorHierarchy:
    ...
    def execute_movement_command(self, command, proprioceptive_feedback, tonic_drive=0.0):
        ...
        if magnitude > 0.01:
            ...
            for idx, neuron in enumerate(self.executive_neurons):
                ...
                neuron.integrate(0.01, magnitude * selectivity * (15.0 + tonic_drive * 10.0))
        else:
        ...
        for neuron in self.coordination_interneurons:
            neuron.integrate(0.01, exec_activity * 46.0)
        ...
        for idx, neuron in enumerate(self.motor_neurons):
            ...
            neuron.integrate(0.01, inter_activity * 36.0 - feedback)
            self.muscle_activation[idx] = neuron.activity_level()
